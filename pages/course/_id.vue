    ...
    <section class="container">
      ...
      <div>
        ...
        <aside class="c-attr-wrap">
          <section class="ml20 mr15">
            ...
            <section class="c-attr-mt" v-if="Number(course.price) === 0">
              <a
                :href="'/player/' + chapterList[0].childVideo[0].videoSourceId"
                title="立即观看"
             ...
             <section class="c-attr-mt" v-if="Number(course.price) != 0">
              <a
                href="#"
                @click="generateOrders(course.id)"
                title="立即购买"
                class="comm-btn c-btn-3"
                >立即购买</a
              >
      ...
      <div class="mt20 c-infor-box">
        <el-tabs type="border-card">
          <el-tab-pane class="el-tab-pane"  label="课程详情"> <article class="fl col-7">
          <section class="mr30">
            <div class="i-box">
              <!-- <div>
                          ...
                          >
                            ...
                            <ol class="lh-menu-ol" style="display: block">
                              <li
                                ...
                                v-for="video in chapter.childVideo"
                                v-bind:key="video.id"
                              >
                                <a
        ...
        <aside class="fl col-3">
          ...
          <el-tab-pane label="学员评论">学员评论</el-tab-pane>
...
export default {
  ...
  methods:{
    generateOrders(id){
        ...
        order.generateOrders(this.order).then(res=>{
